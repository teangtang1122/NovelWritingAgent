...
class DeconstructRequest(BaseModel):
    ...
    reduce_model: Optional[str] = Field(None, description="Model for final reading-analysis merge")
    ...
    include_characters: bool = Field(False, description="Deprecated: deconstruct no longer extracts character profiles")
    include_outline: bool = Field(False, description="Deprecated: deconstruct no longer extracts outline structure")
    include_worldbuilding: bool = Field(False, description="Deprecated: deconstruct no longer extracts worldbuilding entries")
