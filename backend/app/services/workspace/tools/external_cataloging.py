...
async def get_next_external_cataloging_chapter(
    ...
    if not chapter_run:
        return {
            ...
            "data": {"job_id": job_id, "all_done": True},
        }
...
async def save_external_cataloging_facts(
    ...
    return {
        ...
        "data": {"job_id": job_id, "chapter_id": chapter_id, "facts_saved": saved},
    }
...
async def save_external_cataloging_candidates(
    ...
    return {
        ...
        "data": {"job_id": job_id, "chapter_id": chapter_id, "candidates_saved": saved},
    }
